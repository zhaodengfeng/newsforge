...
(function () {
  ...
  if (document.documentElement?.dataset.newsforgeInjected === '1') {
    console.log('[NewsForge] Content script already injected, skipping');
    return;
  }
  if (document.documentElement) {
    document.documentElement.dataset.newsforgeInjected = '1';
  }
