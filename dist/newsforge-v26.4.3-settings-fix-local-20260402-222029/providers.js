...
const PROVIDERS = {
  ...
  qwen:         { name: 'Qwen', type: 'openai', endpoint: 'https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions', model: 'qwen-mt-plus', models: ['qwen-mt-plus', 'qwen-mt-turbo'] },
