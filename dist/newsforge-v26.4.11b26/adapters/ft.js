...
class FTAdapter extends BaseAdapter {
  ...
  _findArticleEndMarker() {
    ...
    for (let i = total - 1; i >= 0; i--) {
      ...
      if (/^(more from the ft|related|recommended|popular in|more stories|explore the ft|try premium|myft|copyright|newsletter|sign up|subscribe|understanding the most|signed in as|edit commenting|show comments)/.test(text)) {
        return allEls[i];
      }
    }
    return null;
  ...
  getParagraphs() {
    ...
    const skipSelector = 'nav, header, footer, aside, [class*="ad-slot"], [class*="ad-container"], [class*="in-article-ad"], [class*="-ad-"], [class*="advert"], [class*="sponsor"], [class*="newsletter"], [class*="promo"], [class*="related"], [class*="article-info"], [class*="byline"], [class*="timestamp"], [class*="meta"]';
