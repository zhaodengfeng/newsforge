...
const PROVIDERS = {
  ...
  openrouter:   { name: 'OpenRouter', type: 'openai', endpoint: 'https://openrouter.ai/api/v1/chat/completions', model: 'gpt-oss-120b:free', models: ['gpt-oss-120b', 'gpt-oss-120b:free'] },
